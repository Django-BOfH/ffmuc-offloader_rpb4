...
### Voraussetzungen ###
Nicht zwingende Voraussetzung für den Bau eines Offloaders mit Hilfe des Ansible-Playbooks hier sind Kenntnisse zur **[Secure Shell](https://dokuwiki.nausch.org/doku.php/centos:ssh_c7)** und zu **[Ansible](https://dokuwiki.nausch.org/doku.php/centos:ansible:start)**. Diese erleichtern natürlich den Umgang ungemein.
